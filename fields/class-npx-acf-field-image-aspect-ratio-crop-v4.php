...
class npx_acf_field_image_aspect_ratio_crop extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		...
		$this->label = __('Image Aspect Ratio Crop');
		$this->category = __("Basic",'acf-image-aspect-ratio-crop'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'acf-image-aspect-ratio-crop'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'acf-image-aspect-ratio-crop'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'acf-image-aspect-ratio-crop'),
				'something_else' => __('Something Else', 'acf-image-aspect-ratio-crop'),
			)
		));
