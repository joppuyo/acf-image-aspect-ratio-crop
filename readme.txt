...
Contributors: adambichler, joppuyo
...
Stable Tag: 6.0.5-dawn.1

ACF field that allows user to crop image to a specific aspect ratio or pixel size

== Description ==

**Fork Note:** This is a maintained fork of the original ACF Image Aspect Ratio Crop plugin by Johannes Siipola (https://github.com/joppuyo/acf-image-aspect-ratio-crop). This version includes custom enhancements and uses version numbering that won't conflict with the original plugin.
